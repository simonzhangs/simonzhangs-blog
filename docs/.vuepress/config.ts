  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/projects/',
        items: [
          { text: 'apple music', link: '/pages/903c54/' },
          { text: 'extension', link: '/' }
        ]
      },
      {
    ...
    footer: {
      ...
      copyrightInfo:
        'Simonzhans | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
